...
public class AppContext {
	...
	*/
	...
	@Bean
	public User user1() {			// <bean id="uesr1" class="User">
	...
	public Contact www() { 		// name 속성이 사용되었으므로 메소드명은 더 이상 Bean의 id가 아닙니다. 아무 이름이나 써도 된다.
		return new Contact("02-333-3333", "02-333-3334");
	}
	
	@Bean(name="user2")			// mame 속성이 추가되면 Bean의 id로 사용됩니다.
	public User aaa() {			// name 속성이 사용되었으므로 메소드명은 더 이상 Bean의 id가 아닙니다. 아무 이름이나 써도 된다.
